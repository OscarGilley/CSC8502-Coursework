...
Renderer::Renderer(Window& parent) : OGLRenderer(parent) {
	...
	sceneDiffuse = SOIL_load_OGL_texture(TEXTUREDIR"doge.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS);
	...
	//sceneTransforms[0] = Matrix4::Rotation(90, Vector3(1, 0, 0)) * Matrix4::Scale(Vector3(10, 10, 1)) * Matrix4::Translation(Vector3(2000, 2000, -2000));
...
void Renderer::UpdateScene(float dt) {
	...
	//starting from 1 skips translating the floor!
	for (int i = 1; i < 4; ++i) {
